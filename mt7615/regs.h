...
#define MT_PDMA_BUSY			BIT(31)
#define WPDMA_GLO_CFG			MT_HIF(0x208)
#define MT_TX_DMA_EN			BIT(0)
#define MT_RX_DMA_EN			BIT(2)
...
#define MT_HIF_PG_INFO			MT_PLE(0x114)
#define MT_HIF_SRC_CNT			GENMASK(27, 16)
